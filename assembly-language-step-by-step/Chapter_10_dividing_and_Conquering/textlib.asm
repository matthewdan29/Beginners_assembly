...
; 
; 
; Build using these commands on Linux: 
; 	nasm -f elf -g -F stabs textlib.asm
;
; Bild using these commads on windows: 
; 	nasm -f win32 textlib.asm -o textlib.o 
;
...
; separated by spaces. Immediately following is a 16-character lin delimited 
; by bertical bare caracters. Because they are adjacent, they can be 
...
; Caracter in the low 128 are also translated to ASCII perid, as is 
; char 127. 
...
; Modifies: 		EAX
; CALLS: 		Nothing 
; DESCRIPTION: 		The value passed in EAX will be placed in both the hex dump portion and in the ASCII portion,
; 			at the position passed in ECX, represented by a space where it is not a printable char
; 
; 
DumpChar: 
...
; Look up low nybble character and insert it into the string: 
	...
	mov byte [DumpLin+edi+2], al		; Write char equivalent to line string

; Look up high nybble character and insert it into the string: 
	and ebx, 00000F0h			; Mask out all but second-lowest nybble
...
;-------------------------------------------------------------------------------------------------
; PrintLine: 	Displays the hex dump lin string via INT 80h sys_write
; UPDATED: 	1/3/26
; IN: 		Nothing
; RETURNS: 	Nothing
; MODIFIES: 	Nothing

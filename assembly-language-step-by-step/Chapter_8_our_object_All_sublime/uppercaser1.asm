...
Read: 	mov eax, 3			; Specify sys_read call
	...
	je Exit 			; Jump if Equal to 0 (0 means EOF) to Exit or fall through to test for lowercase
	...
	ja Write 			; If abouve 'z' in ASCII chart, not lowercase

					; At this point, we have a lowercase character

	sub byte [Buff], 20th		; SUbtract 20h from lowercase to give uppercase...

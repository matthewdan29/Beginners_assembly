...
; Description				: A simple hex dump utility demonstrating the use of separately assembled code
; 					  libraries via EXTERN
; 
; Build using these commands on Linux: 
; 	nasm -f elf -g -f stabs hexdump3.asm
; 	ld -o hexdump3 hexdump3.o <path>/textlib.o
; 
; Bild using these command on Windows: 
; 	nasm -f win32 hexdump3.asm-o hexdump3.o
;	ld -o hexdump3 hexdump3.o
; 
; 
...
; Set up the regester for the process buffer step: 
	xor ecx, ecx				; Clear the buffer pointer to 0
...
Scan: 
	...
	call DumpChar				; Call the char poike procedure 
